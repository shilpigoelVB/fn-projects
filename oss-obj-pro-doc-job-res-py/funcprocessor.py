...
def handler(ctx, data: io.BytesIO = None):
    ...
    ai_result = analyze_document_bulk(config, signer, namespace, bucket_name=bucketName, object_name=resourceName, output_bucket= ai_vision_output_bucket, prefix="ai-vision-document", model_id = modelid, comp_id = compartmentId)
